...
/**
 * add_i_shash - Adds a node to the shash table
 ...
 * @key: The key of the shash table
 * @value: The value to be stored
 *
 ...
 * @key: The key of the shash table
 *
 * Return: Value of the shash table
 */
...
/**
 * shash_table_print - Prints the key of the shash table
...
/**
 * shash_table_print_rev - Prints the key/value of the shash table
 * @ht: A pointer to the shash table
 *
 * Return: no return
 */
